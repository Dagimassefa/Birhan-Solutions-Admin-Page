...
<head>
    ...
    <title>Birhan Solutions|Admin Page|Update Skills</title>
        ...
        <section id="status" class="services sections-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>Update Developer's Skills</h2>

                </div>
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;">
                        <input type="email" class="form-control" name="email_skills" placeholder="Enter Developers's Email Address*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;margin-top:10px;">
                        <input type="text" class="form-control" name="update_skills" id="Skills" placeholder="Developers Skills*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                        <div class="validation"></div>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    if ($con->query($sql) === true) {
        echo '<script>alert("Developer\'s Skills has been updated!")</script>';
        header("Location: Update-personal-info.php?message=Developer's Skills has been updated!");
    }
}
