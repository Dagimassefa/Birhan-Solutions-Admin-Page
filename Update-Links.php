...
<head>
    ...
    <title>Birhan Solutions|Admin Page|Update Links</title>
...
<body>
            ...
            <a href="admin dashboard.php" class="logo d-flex align-items-center">
                ...
                ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Developer's linkedin link has been updated!</strong> <?= $_SESSION['linkedin']; ?>
                ...
                ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Developer's github link has been updated!</strong> <?= $_SESSION['github']; ?>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php
        ...
        <section id="status" class="services sections-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>Update Developers's Linkedin Link</h2>

                </div>
                <form action="update_linkedin.php" method="post">
                    <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;">
                        <input type="email" class="form-control" name="linkedin_email" placeholder="Enter Developers's Email Address*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;margin-top:10px;">
                        <input type="text" class="form-control" name="update_linkedin" id="linkedin" placeholder="Developer's Linkedin Link*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                        <div class="validation"></div>
                    </div>
    ...
    <section id="status" class="services sections-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h2>Update Developers's Github Link</h2>

            </div>
            <form action="update_github.php" method="post">
                <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;">
                    <input type="email" class="form-control" name="github_email" placeholder="Enter Developers's Email Address*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                    <div class="validation"></div>
                </div>
                <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;margin-top:10px;">
                    <input type="text" class="form-control" name="update_github" id="github" placeholder="Developer's Github Link*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                    <div class="validation"></div>
                </div>
                <input type="submit" class="btn btn-primary" name="submit" value="Save" style="margin-left: 47%;margin-top:10px;">
            </form>
