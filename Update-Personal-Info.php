...
<head>
    ...
    <title>Birhan Solutions|Admin Page|Update Personal Information</title>
...
<body>
            ...
            <a href="admin dashboard.php" class="logo d-flex align-items-center">
                ...
                ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Developer's first name has been updated!</strong> <?= $_SESSION['status']; ?>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php
                    unset($_SESSION['status']);
                } elseif (isset($_SESSION['lstatus'])) {
                ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Developer's last name has been updated!</strong> <?= $_SESSION['lstatus']; ?>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php
                    unset($_SESSION['lstatus']);
                } elseif (isset($_SESSION['pstatus'])) {
                ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Developer's phone number has been updated!</strong> <?= $_SESSION['pstatus']; ?>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php
        ...
        <section id="status" class="services sections-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>Update Developers's First Name</h2>

                </div>
                <form action="update_firstname.php" method="post">
                    <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;">
                        <input type="email" class="form-control" name="fname_email" placeholder="Enter Developers's Email Address*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;margin-top:10px;">
                        <input type="text" class="form-control" name="update_fname" id="fname" placeholder="Developer's First Name*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                        <div class="validation"></div>
                    </div>
    ...
    <section id="status" class="services sections-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h2>Update Developers's Last Name</h2>

            </div>
            <form action="update_lastname.php" method="post">
                <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;">
                    <input type="email" class="form-control" name="lname_email" placeholder="Enter Developers's Email Address*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                    <div class="validation"></div>
                </div>
                <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;margin-top:10px;">
                    <input type="text" class="form-control" name="update_lname" id="lname" placeholder="Developer's Last Name*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                    <div class="validation"></div>
                </div>
                <input type="submit" class="btn btn-primary" name="submit" value="Save" style="margin-left: 47%;margin-top:10px;">
            </form>
    ...
    <section id="status" class="services sections-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h2>Update Developers's Phone Number</h2>

            </div>
            <form action="update_phone.php" method="post">
                <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;">
                    <input type="email" class="form-control" name="phone_email" placeholder="Enter Developers's Email Address*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                    <div class="validation"></div>
                </div>
                <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;margin-top:10px;">
                    <input type="tel" class="form-control" name="update_phone" id="phone" placeholder="Developer's Phone Number*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                    <div class="validation"></div>
                </div>
                <input type="submit" class="btn btn-primary" name="submit" value="Save" style="margin-left: 47%;margin-top:10px;">
            </form>
