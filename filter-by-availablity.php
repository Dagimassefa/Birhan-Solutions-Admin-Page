    ...
    <div style="margin-left: 30px;margin-right:30px">
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                            <div class="form-group" style="padding-left: 20%;padding-right: 20%; width: 100%;">
                                <input type="text" class="form-control" name="email_filt_ava" placeholder="Number Of Avaliablity Days Per Week*" required style="height: 40px;border-radius: 10px;font-size: 15px;" />
                                <div class="validation"></div>
                            </div>
                            <input type="submit" class="btn btn-primary" name="submit" value="Search" style="margin-left: 47%;margin-top:2px;margin-bottom:2px;font-size:large;">
                        </form>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<table style=' width:100%;border-collapse: collapse; margin: 25px 0;  font-size: 1.2em; font-family: sans-serif;min-width: 400px;box-shadow: 0 0 20px rgba(0, 0, 0, 0.15); border: 1px solid black;'>";
